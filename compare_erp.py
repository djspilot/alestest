...
# sys.path.insert(0, SCRIPTS_DIR) # Not needed anymore
...
try:
    from src.aag_analyzer import run_aag_analysis as analyze_with_aag, AAGAnalyzer
    AAG_AVAILABLE = True
except ImportError as e:
    print(f"Failed to import AAG: {e}")
    AAG_AVAILABLE = False
except Exception as e: # Catch other errors during import
    print(f"Error importing AAG: {e}")
    AAG_AVAILABLE = False
