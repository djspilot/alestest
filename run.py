...
Features:
- Grondige analyse met uitleg waarom keuzes worden gemaakt
- Automatische unfold voor plaatwerk met zettingen
- Profiel detectie (koker, hoekprofiel, etc.)
- Verbeterde gaten detectie (inner wires + cilindrisch)
- AAG (Attributed Adjacency Graph) feature recognition
