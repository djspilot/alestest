...
```powershell
powershell -ExecutionPolicy Bypass -File alestest/docs/scripts/run_xml_status_pipeline.ps1 \
...
1. Generates XML via `docs/scripts/generate_xml_dxf.py`
2. Validates critical status in `docs/scripts/preserve_xml_status.py`
